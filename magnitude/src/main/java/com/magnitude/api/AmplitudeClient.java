...
import com.magnitude.security.MD5;
...
public class AmplitudeClient {
    ...
    /**
     * The class identifier tag used in logging. TAG = {@code "com.magnitude.api.AmplitudeClient";}
     */
    public static final String TAG = "com.magnitude.api.AmplitudeClient";
    ...
    /**
     * Log revenue v2. Create a {@link com.magnitude.api.Revenue} object to hold your revenue data and
     * properties, and log it as a revenue event using {@code logRevenueV2}.
     *
     * @param revenue a {@link com.magnitude.api.Revenue} object
     * @see com.magnitude.api.Revenue
     * @see <a href="https://github.com/amplitude/Amplitude-Android#tracking-revenue">
     *     Tracking Revenue</a>
     */
     ...
     * {@link com.magnitude.api.Identify} API to set multiple user properties with a single
    ...
    /**
     * Identify. Use this to send an {@link com.magnitude.api.Identify} object containing
     * user property operations to Amplitude server.
     *
     * @param identify an {@link com.magnitude.api.Identify} object
     * @see com.magnitude.api.Identify
     * @see <a href="https://github.com/amplitude/Amplitude-Android#user-properties-and-user-property-operations">
     *     User Properties</a>
     */
